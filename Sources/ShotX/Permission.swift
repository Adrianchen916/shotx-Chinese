...
private struct PermissionPromptView: View {
    ...
    var body: some View {
        VStack(spacing: 18) {
            ...
            VStack(spacing: 6) {
                ...
                Text("ShotX 需要“屏幕录制”权限以截取屏幕和录制视频。")
                    .font(.system(size: 12))
            ...
            Text("已经授权过？更新 ShotX 后，您可能需要在系统设置中**移除**现有项目并**重新添加**，以便系统信任新版本。")
                .font(.system(size: 11))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .lineSpacing(2)
    ...
    private var steps: some View {
        VStack(alignment: .leading, spacing: 10) {
            step(number: 1, text: "点击下方的**打开系统设置**")
            step(number: 2, text: "在“屏幕录制”列表中打开 **ShotX** 开关")
            step(number: 3, text: "**退出并重新打开** ShotX")
        }
        .padding(14)
